...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val vm: WeatherViewModel by viewModels{  WeatherViewModelFactory((application as WeatherApplication).weatherRepository)}
...
@Composable
fun searchableArea(vmClick: (city:String)->Unit){
    Row(modifier = Modifier.padding(16.dp), verticalAlignment = Alignment.CenterVertically) {
        var city: String by remember { mutableStateOf("City") }
...
@Composable
fun SearchableAreaPreview() {
    WeatherDemoTheme {

        searchableArea (vmClick = {})
    }
}
